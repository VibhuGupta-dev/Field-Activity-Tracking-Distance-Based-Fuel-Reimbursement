...
export default function HomePage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-white text-black">
      ...
      {/* Navbar */}
      <header className="relative z-20 max-h-20">
      ...
      <main className="mt-7 relative z-20 mx-auto flex max-w-6xl flex-col items-center px-6 pt-6 pb-24 text-center md:pt-10">
        <h1 className="max-w-3xl font-[family-name:var(--font-playfair)] text-[3rem] font-semibold leading-[1.08] tracking-[-0.02em] sm:text-3xl lg:text-[4rem]">
        ...
        <div className="mt-4 flex flex-col gap-4 sm:flex-row">
          <Link
            href="/login"
            className="rounded-full bg-black px-8 py-3.5 text-[15px] font-medium text-white transition hover:bg-neutral-800"
          >
          ...
          <Link
            href="/login"
            className="rounded-full bg-neutral-100 px-8 py-3.5 text-[15px] font-medium text-neutral-700 transition hover:bg-neutral-200"
          >
            View Demo
          </Link>
        </div>
